...
const probes = [
  ...
  ['source.cpp meta.preprocessor.include.cpp punctuation.definition.directive.cpp', '#809bbd', 1],
  ['source.cpp meta.preprocessor.include.cpp keyword.control.directive.include.cpp', '#809bbd', 1],
  ['source.cuda-cpp meta.preprocessor.include.cuda-cpp punctuation.definition.directive.cuda-cpp', '#809bbd', 1],
  ['source.cuda-cpp meta.preprocessor.include.cuda-cpp keyword.control.directive.include.cuda-cpp', '#809bbd', 1],
  ['source.objc meta.preprocessor.include.objc punctuation.definition.directive.objc', '#809bbd', 1],
  ['source.objc meta.preprocessor.include.objc keyword.control.directive.import.objc', '#809bbd', 1],
  ['source.objc storage.type.objc punctuation.definition.storage.type.objc', '#809bbd', 1],
  ['source.objc storage.type.objc', '#809bbd', 1],
  ['source.python meta.function.decorator.python punctuation.definition.decorator.python', '#809bbd', 1],
  ...
  ['source.ts meta.decorator.ts punctuation.decorator.ts', '#809bbd', 1],
  ['source.ts meta.type.declaration.ts storage.type.type.ts', '#809bbd', 1],
