...
const tokenColors = [
  ...
  colorRule("DEFAULT WHITE", color.white, [
  ...
  colorRule("DEFAULT YELLOW", color.yellow, [
  ...
  colorRule("DEFAULT BLUE", color.blue, [
    // Variables
    "variable.other",
    "variable.parameter",
  ]),
  colorRule("DEFAULT PURPLE", color.purple, [
    // Entities and declarations
  ...
  decorationRule("BOLD ITALIC", "bold italic", [
    // Markup
    "markup.bold markup.italic",
    "markup.bold markup.italic string",
    "markup.changed",
