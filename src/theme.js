...
// COLORS PALETTE:
// BROWN       : #a7925a
// ORANGE      : #d0782a || #A5925C
// YELLOW      : #ddca7e || #DDCA6F || #DBCA81
// BLUE        : #809bbd || #839BBC || #809BBD
// RED || PINK : #FF5370 || #F07178
// GREY        : #717790 || #666
// GREEN       : #96b38a || #96B38A
// PURPLE      : #9a8297 || #998296
function getTheme({ name }) {
  const theme = {
    ...
    colors: {
      ...
      'editorLineNumber.foreground': color.surface,
    ...
    tokenColors: [
      // Provider-agnostic TextMate defaults. Language-specific rules below
      // remain more specific and therefore preserve the original palette.
      {
        name: 'PROVIDER DEFAULTS — WHITE',
        scope: ['keyword.operator', 'operator', 'punctuation'],
        settings: {
          foreground: color.white,
          fontStyle: 'regular',
        },
      ...
      {
        name: 'PROVIDER DEFAULTS — PURPLE',
        scope: ['entity.name.function', 'meta.property-name'],
        settings: {
          foreground: color.purple,
          fontStyle: 'regular',
        },
      },
      // ITALIC DECORATION START
      {
        name: 'BOLD',
        scope: [
          'markup.bold',
      ...
      {
        name: 'ITALIC',
        scope: ['entity.other.attribute-name', 'markup.italic', 'markup.quote'],
        settings: {
          fontStyle: 'italic',
        },
      },
      // ITALIC DECORATION END
      // UNDERLINE DECORATION START
      {
        name: 'UNDERLINE',
        scope: ['markup.underline', '*link*', '*url*', '*uri*'],
        settings: {
          fontStyle: 'underline',
        },
      },
      ...
      // WHITE COLOR START
      {
        ...
        scope: [
          ...
          // "punctuation.definition.template-expression.end.jsx",
      ...
      {
        name: 'WITHE (#FFFFFF) COLOR ITALIC',
        scope: [
      ...
      // YELLOW COLOR START
      {
        ...
        scope: [
          ...
          'meta.var.expr.ts',
          'meta.var.expr.tsx',
          // "meta.var.expr.ts entity.name.function.ts",
          // "meta.var.expr.tsx entity.name.function.tsx",
          // "meta.export.default.ts variable.other.object.ts",
          'meta.property-list',
          ...
          'meta.use.php',
          // "meta.block.tsx meta.function-call.tsx",
          // META END
      ...
      {
        name: 'YELLOW ITALIC (#ddca7e) COLOR',
        scope: [
      ...
      {
        name: 'YELLOW (#ddca7e) COLOR ITALIC UNDERLINE',
      ...
      {
        name: 'PURPLE (#9a8297) COLOR BOLD ITALIC',
        scope: [
          // MARKUP START
          'markup.changed',
          'markup.bold markup.italic',
      ...
      {
        name: 'PURPLE (#9a8297) COLOR ITALIC',
        scope: [
          // COMMENT START
          'comment.line.shebang.js',
          // COMMENT END
    ...
    'terminal.integrated.fontFamily':
      "IBM Plex Mono, Codelia Ligatures, MesloLGS NF, Operator Mono-Book, Fira Code, Menlo, Monaco, 'Courier New', Ubuntu, monospace",
  };
